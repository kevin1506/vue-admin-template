<template>
  <div class="lib-container">
    ...
    <div class="content">
      <div class="panel">
        <div class="head">
          ...
          <div class="opr-btns">
            <el-button type="primary" icon="el-icon-plus" @click="openModal">创建模板库</el-button>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button @click="linkDetail(scope.row)" type="text" size="small">管理模板</el-button>
    ...
    <el-dialog :title="formType === 1 ? '创建模板库' : '编辑模板库'" @close="closeModal" :visible.sync="dialogFormVisible" width="450px">
      <el-form :model="form" :rules="rules" ref="addForm">
        ...
        <el-form-item label="模板库名称" :label-width="formLabelWidth" prop="name">
          <el-input v-model="form.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="模板库描述" :label-width="formLabelWidth" prop="desc">
...
<script>
import { getLibList, addLibItem, delLibItem, changeLibStatus, getLibDetail } from '@/api/tempManage'
export default {
  name: 'control-main',
  data () {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '请输入模板库名称', trigger: 'blur' }
        ]
      }
    }
  },
