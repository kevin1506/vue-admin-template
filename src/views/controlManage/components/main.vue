<template>
  <div class="lib-container">
    ...
    <el-dialog :title="formType === 1 ? '创建控件库' : '编辑控件库'" @close="closeModal" :visible.sync="dialogFormVisible" width="450px">
...
<script>
import { getLibList, addLibItem, delLibItem, changeLibStatus, getLibDetail } from '@/api/controlManage'
export default {
  name: 'control-main',
  data () {
    return {
